...
//        z = z * z * z;
        ...
        if(gamepad2.a) sweeper.setPower(1);
        else if(gamepad2.b) sweeper.setPower(-1);
        else sweeper.setPower(0);

        if(gamepad2.right_bumper) elevator.setPower(speed);
        else if(gamepad2.left_bumper) elevator.setPower(-speed);
        ...
        if(gamepad2.right_trigger > 0 && (touch.isPressed() == false || gamepad2.left_trigger > 0))
        {
//            telemetry.addData(">", touch.isPressed());
//            telemetry.update();
//            telemetry.addData(">", "touch", touch.isPressed() + "");
//            telemetry.addData(">", "dpad", gamepad2.dpad_down);
//            telemetry.update();
...
//            temporary = servo.getPosition();
//            temporary += 0.2;
//
//            temporary = temporary % 1.0;
//
//            Range.clip(temporary, 0, 1);
//
//            if(temporary > 1.0)
//            {
//                temporary = 1.0;
//            }
//
//            telemetry.addData("temporary", temporary);
//            telemetry.update();
//
//            servo.setPosition(temporary);
//            sleep(200);
...
//        telemetry.addData("servo", "servo:" + servoposition);
//        telemetry.update();
        /*if(gamepad2.right_trigger > 0 && touch.isPressed() == false) launcher.setPower(1);
