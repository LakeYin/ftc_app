...
public class VuforiaB2 extends AutonomousMethodMaster{
    ...
    public void runOpMode()
    {
        ...
        int timesScanned = 0; // How many times the robot has attempted to identify the VuMark
        ...
        // Sets value to move_inches based on the VuMark
        ...
        while (vuMark != RelicRecoveryVuMark.UNKNOWN && (tY < ((double) 36 + phone_displacement + pictograph_displacement) * inchToMm)) // 36 as in 36 inches
        {
            ...
            if(pose != null) {
                ...
                // Gets the robot orientation from the phone
